            ...
            <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-2 pb-4">
              ...
              <nav class="flex flex-1 flex-col">
                <ul role="list" class="flex flex-1 flex-col gap-y-7">
                  <li>
                    <form id="searchForm" action="{{ route('menus.index', ['id' => $id]) }}" method="GET" class="md:block">
                      <div>
                          <!-- Search Field -->
                          ...
                          <div class="flex justify-between items-center gap-x-6 mt-2">
                              <a href="{{ route('menus.index', ['id' => $id]) }}" id="resetButton" class="text-sm font-semibold leading-6 text-gray-900 cursor-pointer">{{ __('Réinitialiser') }}</a>
