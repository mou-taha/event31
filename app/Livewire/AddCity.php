...
class AddCity extends Component
{
    ...
    {
        $this->validate([
            'name' => 'required|unique:cities,name,' . $this->cityId,
        ]);
        ...
        $city = City::updateOrCreate(['id' => $this->cityId], [
            'name' => $this->name,
        ...
        $this->dispatch('cityAdded', $city->id);
    ...
    public function render()
    {
        ...
        return view('livewire.add-city', compact('cities'));
    }
}
