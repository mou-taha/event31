    ...
    <div class="fixed inset-0 z-40 flex">
      ...
      <div class="relative flex w-full max-w-xs flex-1 flex-col bg-emerald-700 pb-4 pt-5">
        ...
        <div class="flex flex-shrink-0 items-center px-4">
          <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=emerald&shade=300" alt="Easywire logo">
        </div>
        <nav class="mt-5 h-full flex-shrink-0 divide-y divide-emerald-800 overflow-y-auto" aria-label="Sidebar">
          <div class="space-y-1 px-2">
            <!-- Current: "bg-emerald-800 text-white", Default: "text-emerald-100 hover:bg-emerald-600 hover:text-white" -->
            <a href="#" class="bg-emerald-800 text-white group flex items-center rounded-md px-2 py-2 text-base font-medium" aria-current="page">
            ...
            <a href="#" class="text-emerald-100 hover:bg-emerald-600 hover:text-white group flex items-center rounded-md px-2 py-2 text-base font-medium">
              <svg class="mr-4 h-6 w-6 flex-shrink-0 text-emerald-200" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
          ...
          <div class="mt-6 pt-6">
            <div class="space-y-1 px-2">
              <a href="#" class="group flex items-center rounded-md px-2 py-2 text-base font-medium text-emerald-100 hover:bg-emerald-600 hover:text-white">
  ...
  <div class="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
    ...
    <div class="flex flex-grow flex-col overflow-y-auto bg-emerald-700 pb-4 pt-5">
      ...
      <nav class="mt-5 flex flex-1 flex-col divide-y divide-emerald-800 overflow-y-auto" aria-label="Sidebar">
        <div class="space-y-1 px-2">
          <!-- Current: "bg-emerald-800 text-white", Default: "text-emerald-100 hover:bg-emerald-600 hover:text-white" -->
          <a href="#" class="bg-emerald-800 text-white group flex items-center rounded-md px-2 py-2 text-sm font-medium leading-6" aria-current="page">
            <svg class="mr-4 h-6 w-6 flex-shrink-0 text-emerald-200" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
            </svg>
            Home
          </a>
          <a href="#" class="text-emerald-100 hover:bg-emerald-600 hover:text-white group flex items-center rounded-md px-2 py-2 text-sm font-medium leading-6">
            <svg class="mr-4 h-6 w-6 flex-shrink-0 text-emerald-200" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            History
        ...
        <div class="mt-6 pt-6">
          <div class="space-y-1 px-2">
            <a href="#" class="group flex items-center rounded-md px-2 py-2 text-sm font-medium leading-6 text-emerald-100 hover:bg-emerald-600 hover:text-white">
              <svg class="mr-4 h-6 w-6 text-emerald-200" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m16.5 0H21m-1.5 0H12m-8.457 3.077l1.41-.513m14.095-5.13l1.41-.513M5.106 17.785l1.15-.964m11.49-9.642l1.149-.964M7.501 19.795l.75-1.3m7.5-12.99l.75-1.3m-6.063 16.658l.26-1.477m2.605-14.772l.26-1.477m0 17.726l-.26-1.477M10.698 4.614l-.26-1.477M16.5 19.794l-.75-1.299M7.5 4.205L12 12m6.894 5.785l-1.149-.964M6.256 7.178l-1.15-.964m15.352 8.864l-1.41-.513M4.954 9.435l-1.41-.514M12.002 12l-3.75 6.495" />
              </svg>
              Settings
