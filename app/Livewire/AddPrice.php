...
class AddPrice extends Component
{
    ...
    {
        $this->validate([
            'name' => 'required|unique:prices,name,' . $this->priceId,
        ]);
        ...
        $price = Price::updateOrCreate(['id' => $this->priceId], [
            'name' => $this->name,
        ...
        $this->dispatch('priceAdded', $price->id);
    ...
    public function render()
    {
        ...
        return view('livewire.add-price', compact('prices'));
    }
}
