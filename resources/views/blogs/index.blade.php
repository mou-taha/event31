        ...
        <div class="bg-white py-24 sm:py-32">
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
              <div class="mx-auto max-w-2xl text-center">
                <p class="mt-2 text-xl font-bold leading-8 text-gray-800">Inspirer l'Innovation, Allumer les Idées : Explorez nos Blogs.</p>
              </div>
              <form action="{{ route('blogs.index') }}" method="get" class="md:block">
                <div class="relative mt-4 flex items-center">
                  <input type="text" name="search" id="search" value="{{request()->search}}" placeholder="Recherche rapide" class="  block w-full rounded-lg border-0 px-3 py-1 pr-14 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:text-sm sm:leading-6">
              ...
              <div class="mx-auto mt-6 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                ...
                <article class="flex flex-col items-start justify-between">
                  <div class="relative w-full">
                    ...
                    <img src="{{ asset('storage/' . $blog->thumbnail) }}" alt="{{ $blog->thumbnail }}" class="aspect-[16/9] w-full rounded-2xl bg-gray-100 object-cover sm:aspect-[2/1] lg:aspect-[3/2]">
                    </a>
                  ...
                  <div class="max-w-xl">
                    <div class="mt-2 flex items-center gap-x-4 text-xs">
                      @if ($blog->category)
                      <a href="{{ route('blogs.byCategory', ['category' => $blog->category]) }}" class="relative z-10 rounded-md bg-gray-50 px-3 py-1.5 font-medium text-green-600 hover:bg-gray-100">{{ $blog->category->name }}</a>
                      @endif
                    </div>
                    <div class="group relative">
                      ...
                      <p class="mt-2 line-clamp-3 text-sm leading-6 text-gray-600">{{ $blog->content }}</p>
                    </div>
                  </div>
                </article>
                @empty
                <div class="rounded-md bg-green-50 col-span-3 mb-16 p-4">
                    <div class="flex">
                      ...
                      <div class="ml-3">
                        <p class="text-sm font-medium text-green-800">Aucun resultat</p>
                      </div>
                    </div>
                  </div>
                @endforelse
